...
import com.dinosoftlabs.foodies.android.Adapters.SlidingImageAdapter;
...
public class RestaurantsFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks{
    ...
    public void getRestaurantList(){
        ...
        try {
            ...
            jsonObject.put("user_id",user_id != null && user_id.length() > 0 ? user_id: "1");
...
// Request a string response from the provided URL.
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,Config.SHOW_RESTAURANTS,jsonObject, new Response.Listener<JSONObject>() {
                        ...
                        try {
                            ...
                            if (code_id == 200) {
                                ...
                                for (int i = 0; i < jsonarray.length(); i++) {
                                    ...
                                    if (distance.equals("null") || distance == null || distance.equals(""))
                                        distance = "0.0";
