				...
				foreach( $json_data['msg'] as $str => $val ) {
					...
					<div class="form col50 left">
						<form action="dashboard.php?p=bankinfo&edit=inf" id="hotelbnkinffrm" method="post">
							<p><input type="text" name="nm" id="nm" value="<?php echo $val['BankingInfo']['name']; ?>" required=''><label alt='Name' placeholder='Name'></label></p>
                           <div class="col50 left">
								<p><input type="text" name="trnum" id="trnum" value="<?php echo $val['BankingInfo']['transit_no']; ?>" required=''><label alt='Transit Number' placeholder='Transit Number'></label></p>
							</div>
							<div class="col50 right">
								<p><input type="text" name="bnkno" id="bnkno" placeholder="Bank Number" value="<?php echo $val['BankingInfo']['bank_no']; ?>" required=''><label alt='Bank Number' placeholder='Bank Number'></label></p>
							</div>
							<div class="clear" style="height: 15px;"></div>
							<p><input type="text" name="accno" id="accno" placeholder="Account Number" value="<?php echo $val['BankingInfo']['account_no']; ?>" required=''><label alt='Account Number' placeholder='Account Number'></label></p>
