...
<!-- START Categories Inner -->
<section class="cat_innersec">
	 ...
	 <div class="row">			 
		     <div class="col-md-11 col-md-offset-2">
				  <div class="col-md-4 col-sm-4">
					  <div class="thumb_catinner">			    
						  <a href="#">
							<img class="img-responsive" src="images/cat1.jpg"/>
						  </a>	
						  <div class="overlay">
				  ...
				  <div class="col-md-4 col-sm-4">
					  <div class="thumb_catinner">			    
						  <a href="#">
							<img class="img-responsive imgh2" src="images/cat2.jpg"/>
						  </a>
						   <div class="overlay">
       ...
       <div class="row mt">			
		    <div class="col-md-12 col-sm-12">	
              		 <div class="col-md-4 col-sm-4">
						  <div class="thumb_catinner">			    
							  <a href="#">
								<img class="img-responsive imgh3" src="images/cat2.jpg"/>
							  </a>
							   <div class="overlay">
                  ...
                  <div class="col-md-4 col-sm-4">
					   <div class="thumb_catinner">			    
						  <a href="#">
							<img class="img-responsive imgh4" src="images/cat1.jpg"/>
						  </a>
 						   <div class="overlay">
                 ...
                 <div class="col-md-4 col-sm-4">
					  <div class="thumb_catinner">			    
						  <a href="#">
							<img class="img-responsive imgh5" src="images/cat2.jpg"/>
						  </a>	
						   <div class="overlay">
