  ...
  <div id="page_content_sec">
    <div class="login_form">
      <div class="right col100 rightside">
        ...
        <div class="form">
          <form  action = "confirm.php?log=in" id="loginfrm" method="post" novalidate="novalidate" name="registration">
            <p>
              <input name="eml" id="eml" required="" aria-required="true" type="email">
